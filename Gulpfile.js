...
/**
 * Delete user-account-management.css and user-account-management.min.css before we minify and optimize
 */
gulp.task( 'clean:styles', () =>
	del( [ 'assets/css/user-account-management.css', 'assets/css/user-account-management.min.css' ] )
);
...
gulp.task( 'postcss', [ 'clean:styles' ], () =>
	gulp.src( 'assets/sass/*.scss', paths.css )
		...
		// Create user-account-management.css.
		.pipe( gulp.dest( 'assets/css/' ) )
		.pipe( browserSync.stream() )
);

/**
 * Minify and optimize user-account-management.css.
 *
 * https://www.npmjs.com/package/gulp-cssnano
 */
gulp.task( 'cssnano', [ 'postcss' ], () =>
	gulp.src( 'assets/css/user-account-management.css' )
		.pipe( plumber( {'errorHandler': handleErrors} ) )
		.pipe( cssnano( {
			'safe': true // Use safe optimizations.
		} ) )
		.pipe( rename( 'user-account-management.min.css' ) )
		.pipe( gulp.dest( 'assets/css' ) )
		.pipe( browserSync.stream() )
);
...
gulp.task( 'concat', () =>
	gulp.src( paths.concat_scripts )
		...
		.pipe( concat( 'user-account-management.js' ) )

		// Append the sourcemap to user-account-management.js.
		.pipe( sourcemaps.write() )

		// Save user-account-management.js
 ...
 */
gulp.task( 'clean:pot', () =>
	del( [ 'languages/user-account-management.pot' ] )
);
...
gulp.task( 'wp-pot', [ 'clean:pot' ], () =>
	gulp.src( paths.php )
		...
		.pipe( gulp.dest( 'languages/user-account-management.pot' ) )
);
